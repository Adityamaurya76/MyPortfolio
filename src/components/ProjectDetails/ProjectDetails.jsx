...
const Wrapper = styled.div`
  ...
  box-shadow: 0 20px 40px ${({ theme }) => theme.bg === '#f8fafc' ? 'rgba(15, 23, 42, 0.06)' : 'rgba(0, 0, 0, 0.5)'};
...
const CloseButton = styled.div`
  ...
  &:hover {
    background: ${({ theme }) => theme.bg === '#f8fafc' ? 'rgba(15, 23, 42, 0.1)' : 'rgba(255, 255, 255, 0.15)'};
...
const Tag = styled.div`
    ...
    padding: 6px 12px;
    border-radius: 8px;
    background-color: ${({ theme }) => theme.bg === '#f8fafc' ? 'rgba(124, 58, 237, 0.08)' : 'rgba(168, 85, 247, 0.1)'};
    border: 1px solid ${({ theme }) => theme.bg === '#f8fafc' ? 'rgba(124, 58, 237, 0.15)' : 'rgba(168, 85, 247, 0.2)'};
    @media only screen and (max-width: 600px) {
        font-size: 12px;
    }
`;
